...
int main()
{
    ...
    BOOST_TEST_EQ( digest<boost::hash2::openssl::md5_128>( "" ), std::string( "d41d8cd98f00b204e9800998ecf8427e" ) );
    BOOST_TEST_EQ( digest<boost::hash2::openssl::md5_128>( "a" ), std::string( "0cc175b9c0f1b6a831c399e269772661" ) );
    BOOST_TEST_EQ( digest<boost::hash2::openssl::md5_128>( "abc" ), std::string( "900150983cd24fb0d6963f7d28e17f72" ) );
    BOOST_TEST_EQ( digest<boost::hash2::openssl::md5_128>( "message digest" ), std::string( "f96b697d7cb7938d525a2f31aaf161d0" ) );
    BOOST_TEST_EQ( digest<boost::hash2::openssl::md5_128>( "abcdefghijklmnopqrstuvwxyz" ), std::string( "c3fcd3d76192e4007dfb496cca67e13b" ) );
    BOOST_TEST_EQ( digest<boost::hash2::openssl::md5_128>( "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789" ), std::string( "d174ab98d277d9f5a5611c2c9f419d9f" ) );
    BOOST_TEST_EQ( digest<boost::hash2::openssl::md5_128>( "12345678901234567890123456789012345678901234567890123456789012345678901234567890" ), std::string( "57edf4a22be3c955ac49da2e2107b67a" ) );
