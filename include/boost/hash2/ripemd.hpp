...
private:
    ...
    void transform( unsigned char const block[ 64 ] )
    {
        ...
        RR5(aaa, bbb, ccc, ddd, eee, X[ 5],  8);
        RR5(eee, aaa, bbb, ccc, ddd, X[14],  9);
        RR5(ddd, eee, aaa, bbb, ccc, X[ 7],  9);
        RR5(ccc, ddd, eee, aaa, bbb, X[ 0], 11);
        RR5(bbb, ccc, ddd, eee, aaa, X[ 9], 13);
        RR5(aaa, bbb, ccc, ddd, eee, X[ 2], 15);
        RR5(eee, aaa, bbb, ccc, ddd, X[11], 15);
        RR5(ddd, eee, aaa, bbb, ccc, X[ 4],  5);
        RR5(ccc, ddd, eee, aaa, bbb, X[13],  7);
        RR5(bbb, ccc, ddd, eee, aaa, X[ 6],  7);
        RR5(aaa, bbb, ccc, ddd, eee, X[15],  8);
        RR5(eee, aaa, bbb, ccc, ddd, X[ 8], 11);
        RR5(ddd, eee, aaa, bbb, ccc, X[ 1], 14);
        RR5(ccc, ddd, eee, aaa, bbb, X[10], 14);
        RR5(bbb, ccc, ddd, eee, aaa, X[ 3], 12);
        RR5(aaa, bbb, ccc, ddd, eee, X[12],  6);

        RR4(eee, aaa, bbb, ccc, ddd, X[ 6],  9);
        RR4(ddd, eee, aaa, bbb, ccc, X[11], 13);
        RR4(ccc, ddd, eee, aaa, bbb, X[ 3], 15);
        RR4(bbb, ccc, ddd, eee, aaa, X[ 7],  7);
        RR4(aaa, bbb, ccc, ddd, eee, X[ 0], 12);
        RR4(eee, aaa, bbb, ccc, ddd, X[13],  8);
        RR4(ddd, eee, aaa, bbb, ccc, X[ 5],  9);
        RR4(ccc, ddd, eee, aaa, bbb, X[10], 11);
        RR4(bbb, ccc, ddd, eee, aaa, X[14],  7);
        RR4(aaa, bbb, ccc, ddd, eee, X[15],  7);
        RR4(eee, aaa, bbb, ccc, ddd, X[ 8], 12);
        RR4(ddd, eee, aaa, bbb, ccc, X[12],  7);
        RR4(ccc, ddd, eee, aaa, bbb, X[ 4],  6);
        RR4(bbb, ccc, ddd, eee, aaa, X[ 9], 15);
        RR4(aaa, bbb, ccc, ddd, eee, X[ 1], 13);
        RR4(eee, aaa, bbb, ccc, ddd, X[ 2], 11);
        ...
        RR2(ccc, ddd, eee, aaa, bbb, X[ 8], 15);
        RR2(bbb, ccc, ddd, eee, aaa, X[ 6],  5);
        RR2(aaa, bbb, ccc, ddd, eee, X[ 4],  8);
        RR2(eee, aaa, bbb, ccc, ddd, X[ 1], 11);
        RR2(ddd, eee, aaa, bbb, ccc, X[ 3], 14);
        RR2(ccc, ddd, eee, aaa, bbb, X[11], 14);
        RR2(bbb, ccc, ddd, eee, aaa, X[15],  6);
        RR2(aaa, bbb, ccc, ddd, eee, X[ 0], 14);
        RR2(eee, aaa, bbb, ccc, ddd, X[ 5],  6);
        RR2(ddd, eee, aaa, bbb, ccc, X[12],  9);
        RR2(ccc, ddd, eee, aaa, bbb, X[ 2], 12);
        RR2(bbb, ccc, ddd, eee, aaa, X[13],  9);
        RR2(aaa, bbb, ccc, ddd, eee, X[ 9], 12);
        RR2(eee, aaa, bbb, ccc, ddd, X[ 7],  5);
        RR2(ddd, eee, aaa, bbb, ccc, X[10], 15);
        RR2(ccc, ddd, eee, aaa, bbb, X[14],  8);

        RR1(bbb, ccc, ddd, eee, aaa, X[12] ,  8);
        RR1(aaa, bbb, ccc, ddd, eee, X[15] ,  5);
        RR1(eee, aaa, bbb, ccc, ddd, X[10] , 12);
        RR1(ddd, eee, aaa, bbb, ccc, X[ 4] ,  9);
        RR1(ccc, ddd, eee, aaa, bbb, X[ 1] , 12);
        RR1(bbb, ccc, ddd, eee, aaa, X[ 5] ,  5);
        RR1(aaa, bbb, ccc, ddd, eee, X[ 8] , 14);
        RR1(eee, aaa, bbb, ccc, ddd, X[ 7] ,  6);
        RR1(ddd, eee, aaa, bbb, ccc, X[ 6] ,  8);
        RR1(ccc, ddd, eee, aaa, bbb, X[ 2] , 13);
        RR1(bbb, ccc, ddd, eee, aaa, X[13] ,  6);
        RR1(aaa, bbb, ccc, ddd, eee, X[14] ,  5);
        RR1(eee, aaa, bbb, ccc, ddd, X[ 0] , 15);
        RR1(ddd, eee, aaa, bbb, ccc, X[ 3] , 13);
        RR1(ccc, ddd, eee, aaa, bbb, X[ 9] , 11);
        RR1(bbb, ccc, ddd, eee, aaa, X[11] , 11);
